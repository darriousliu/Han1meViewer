...
class OrientationManager(
    ...
    enum class ScreenOrientation {
        ...
        val isPortrait: Boolean get() = this == PORTRAIT || this == REVERSED_PORTRAIT
    ...
    fun isOrientationLocked(): Boolean = lastLockedOrientation != null

    fun getCurrentScreenOrientation(): ScreenOrientation = screenOrientation
    ...
    override fun onOrientationChanged(orientation: Int) {
        ...
        try {
            ...
            if (autoRotateEnabled == 0) return
        } catch (e: Settings.SettingNotFoundException) {
            Log.w("OrientationManager", "Unable to read auto-rotate setting", e)
        }
