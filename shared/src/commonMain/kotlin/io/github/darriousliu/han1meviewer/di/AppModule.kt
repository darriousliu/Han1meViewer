 ...
 * 这里改成汇总它们。
 */
@Module(includes = [CheckinModule::class, HistoryModule::class, SubscriptionModule::class, CommentModule::class, PreviewModule::class, MylistModule::class, DownloadModule::class])
