...
import io.github.darriousliu.han1meviewer.SEARCH_YEAR_RANGE_END
import io.github.darriousliu.han1meviewer.SEARCH_YEAR_RANGE_START
...
import io.github.darriousliu.han1meviewer.logic.model.SearchOption.Companion.flatten
import io.github.darriousliu.han1meviewer.logic.model.SearchOption.Companion.get
import io.github.darriousliu.han1meviewer.ui.component.SelectableTag
import io.github.darriousliu.han1meviewer.ui.component.SettingChoiceItem
...
import io.github.darriousliu.han1meviewer.ui.model.AdvancedSearchDialogState
import io.github.darriousliu.han1meviewer.ui.model.SearchScopeSection
...
import io.github.darriousliu.han1meviewer.core.resource.approximate_range
...
import io.github.darriousliu.han1meviewer.core.resource.ic_baseline_search_24
import io.github.darriousliu.han1meviewer.core.resource.pair_widely
import io.github.darriousliu.han1meviewer.core.resource.pair_widely_alert
...
import io.github.darriousliu.han1meviewer.core.resource.save
import io.github.darriousliu.han1meviewer.core.resource.search
import io.github.darriousliu.han1meviewer.core.resource.search_options_tips
...
import io.github.darriousliu.han1meviewer.core.resource.specific_y_m
...
import io.github.darriousliu.han1meviewer.core.resource.switch_to_year
import io.github.darriousliu.han1meviewer.core.resource.switch_to_year_month
...
private fun AdvancedSearchActionSection(
    ...
    Column(
        ...
        FilledIconButton(
            ...
            Icon(
                painter = painterResource(Res.drawable.ic_baseline_search_24),
